...
public class MainActivity extends AppCompatActivity {
    ...
    private void checkEnd(){
        ...
        iv_44.getVisibility() == View.INVISIBLE) {
            ...
            alertDialogBuilder.setMessage("Игра окончена!\n");
            alertDialogBuilder.setCancelable(false);
            alertDialogBuilder.setPositiveButton("Начать новую", new DialogInterface.OnClickListener() {
                @Override
    ...
    private void frontOfCardsResources(){
        ...
        image207 = R.drawable.image107;
        image208 = R.drawable.image108;
    }
